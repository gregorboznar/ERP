                                        ...
                                        <thead class="divide-y divide-gray-200 dark:divide-white/10">
                                            <tr class="bg-gray-50 dark:bg-white/5">
                                                <th
                                                    ...
                                                    {{ __('messages.maintenance_points') }}
                                                </th>
                                                @php
                                                    $days = [
                                                        __('messages.mon'),
                                                        ...
                                                        <td class="fi-ta-cell px-3 py-4 text-center">
                                                            ...
                                                            @if ($checkPoint)
                                                                @if ($checkPoint->pivot->checked)
                                                                    <span
                                                                        class="inline-flex items-center justify-center w-6 h-6 rounded-full text-green-600 dark:bg-green-800/20 dark:text-green-400">
                                ...
                                <div class="fi-empty-state p-6 text-center">
                                    <div class="fi-empty-state-content">
                                        <div class="text-gray-500 dark:text-gray-400">
                                            {{ __('messages.no_maintenance_points_defined_for', ['machine' => $machine->title]) }}
                                        </div>
                                    </div>
                                </div>
                            @endif
