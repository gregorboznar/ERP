<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="col-span-1">
            <label
                class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('messages.select_machine') }}</label>
        ...
        <div class="col-span-1">
            <label
                class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('messages.check_date') }}</label>
            ...
            @if (isset($data['machine_id']) && $data['machine_id'])
                ...
                @else
                    <div class="p-4 text-sm text-gray-500 dark:text-gray-400">
                        No maintenance points found for this machine. Please make sure maintenance points are assigned
                        to this machine.
                    </div>
                @endif
            @else
