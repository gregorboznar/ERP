...
<head>
    ...
    <title>Laravel</title>
    <!-- Filament Shield -->
    <link href="{{ asset('vendor/filament/filament.css') }}" rel="stylesheet">
    ...
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/css/main.css', 'resources/css/filament/admin/custom.css'])
    @else
